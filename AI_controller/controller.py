...
#--------------------------------------------------------------------------------------------------------
    ...
    def compute_features(self, state):
        ...
        wheel = 1200 * (state.wheel_x) - (state.wheel_x * state.wheel_x)
        angle = 3600 - (state.rod_angle * state.rod_angle)
        features = [state.wheel_x, state.rod_angle, state.angular_velocity,  state.wind, state.friction]
